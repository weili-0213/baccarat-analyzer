 ...
 * Cockroach    = 3
 */
const COMPARISON_GAP = 2;


export default class SmallRoad {
    ...
    validateColor(color) {
        ...
        if (
            ...
            throw new Error(
                `Invalid small road color: ${color}`
            );
    ...
    static fromJSON(data) {
        ...
        if (
            ...
            throw new Error(
                "Small Road entries are required."
            );
